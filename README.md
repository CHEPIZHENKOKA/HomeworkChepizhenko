...
Функция выборки успешных/неуспешных транзакций 
1. Запустите processing.py.
2. Введите запрошенные данные.
3. Программа выведет обработанные данные.

В модуле generators.py доступны функции фильтрации транзакций по валюте и описанию.
