...
def test_filter_by_currency(transactions_data, currency, expected_ids):
    ...
    gen = filter_by_currency(transactions_data, currency)

    # Проверяем все ожидаемые ID
    results = []
...
def test_transaction_descriptions(transactions_data):
    ...
    gen = transaction_descriptions(transactions_data)
...
def test_card_number_generator(start, end, expected):
    """Параметризованное тестирование генератора номеров карт"""
