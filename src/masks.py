...
def get_mask_card_number(card_number: Union[str, int]) -> str:
    ...
    first_four_numbers = card_str[:4]
    next_two = card_str[4:6]
    last_four_numbers = card_str[-4:]
    masked_card_number = f"{first_four_numbers} {next_two}** **** {last_four_numbers}"
...
def get_mask_account(account_number: Union[str, int]) -> str:
    ...
    **XXXX"""
    ...
    last_four_numbers = account_str[-4:]
    masked_account_number = f"**{last_four_numbers}"
